...
export default class ZVenueCard extends Component {
  ...
  renderAvatar = () => {
    if (this.props.avatar) {
      ...
      return(
        <Image style={{width: 100, height: 100, resizeMode: 'stretch'}} source={{uri: 'https://www.uratex.com.ph/wp-content/themes/uratex-custom/img/placeholder.jpg'}}/>
      )
    }
  }
  ...
  renderDetails = () => {
    return(
      <View>
        <Text style={{fontSize: 14, marginVertical: 5, color: '#78757E'}}> {this.props.job}  <Text style={{fontSize: 14, color: '#78757E'}}>{this.props.jobType}</Text></Text>
  ...
  renderServices = () => {
    if(this.props.services){
      return (
        <View style={{flex: 1}}>
          <ZSliderCard>
            <Text style={{fontSize: 16, color: '#78757E', alignSelf: 'center', marginRight: 10, paddingRight: 5}}>Services :</Text>
            <ZIcon photoUrlSelected={require('../Assets/alcoholicon.png')} photoUrlUnSelected={require('../Assets/alcoholiconselected.png')} isSelected={this.props.isAlcohol} small={true} />
            <ZIcon photoUrlSelected={require('../Assets/drinkingicon.png')} photoUrlUnSelected={require('../Assets/drinkingiconselected.png')} isSelected={this.props.isDrinks} small={true} />
            <ZIcon photoUrlSelected={require('../Assets/drinkicon.png')} photoUrlUnSelected={require('../Assets/drinkiconselected.png')} isSelected={this.props.isLunch} small={true} />
            <TouchableOpacity onPress={this.props.onPressMore}>
              <View style={{flex: 1, flexDirection: 'row', width: 35, height: 35, borderRadius: 18, borderWidth: 1, borderColor: '#AAA6C7', alignItems: 'center', justifyContent: 'center'}}>
                <View style={{flex: 1, alignItems: 'center', justifyContent: 'center', padding: 5}}>
                  <View style={{width: 7, height: 7, borderRadius: 4, borderWidth: 1.2, borderColor: '#5352B5'}}>
                  </View>
                </View>
