            ...
            return (
                <ZSliderCard>
                    <ZRoundedButton name="All" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByVenue('All', 1, value)}/>
                    <ZRoundedButton name="Cafe" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByVenue('Cafe', 2, value)}/>
                    <ZRoundedButton name="Restaurant" isSelected={this.state.selected} selectedColor="#64DAE7"
                                    height={35}
                                    selectedButton={(value) => this.getFilterByVenue('Restaurant', 3, value)}/>
                    <ZRoundedButton name="Bar" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByVenue('Bar', 4, value)}/>
                    <ZRoundedButton name="Club" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByVenue('Club', 5, value)}/>
                    <ZRoundedButton name="Pub" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByVenue('Pub', 6, value)}/>
                </ZSliderCard>
            )
        }
    }
    ...
    renderTypeService = () => {
        if (this.state.isTypeService) {
            return (
                <ZSliderCard>
                    <ZRoundedButton name="All" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByService('All', 1, value)}/>
                    <ZRoundedButton name="Alcohol" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByService('Alcohol', 2, value)}/>
                    <ZRoundedButton name="Drinks" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByService('Drinks', 3, value)}/>
                    <ZRoundedButton name="Food" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByService('Food', 4, value)}/>
                    <ZRoundedButton name="Pokies" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByService('Pokies', 5, value)}/>
                    <ZRoundedButton name="Cocktails" isSelected={this.state.selected} selectedColor="#64DAE7"
                                    height={35}
                                    selectedButton={(value) => this.getFilterByService('Cocktails', 6, value)}/>
                    <ZRoundedButton name="Breakfast" isSelected={this.state.selected} selectedColor="#64DAE7"
                                    height={35}
                                    selectedButton={(value) => this.getFilterByService('Breakfast', 7, value)}/>
                    <ZRoundedButton name="Lunch" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByService('Lunch', 8, value)}/>
                    <ZRoundedButton name="Dinner" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByService('Dinner', 9, value)}/>
                    <ZRoundedButton name="Hotel" isSelected={this.state.selected} selectedColor="#64DAE7" height={35}
                                    selectedButton={(value) => this.getFilterByService('Hotel', 10, value)}/>
                </ZSliderCard>
            )
        }
    }
                    ...
                    <View style={{justifyContent: 'center', alignItems: 'center'}}>
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <View>
                                    <ZIcon photoUrlSelected={require('../Assets/alcoholicon.png')}
                                           ...
                                           isSelected={this.state.isAlcohol} size={50}
                                           selectedIcon={() => this.setState({isAlcohol: true})}/>
                                ...
                                <View>
                                    <ZIcon photoUrlSelected={require('../Assets/drinkingicon.png')}
                                           ...
                                           isSelected={this.state.isDrinks} size={50}
                                           selectedIcon={() => this.setState({isDrinks: true})}/>
                                    <Text style={{paddingLeft: 7, color: '#5E5CBD', fontWeight: '500'}}>Drinks</Text>
                                </View>
                                <View>
                                    <ZIcon photoUrlSelected={require('../Assets/coctailicon.png')}
                                           photoUrlUnSelected={require('../Assets/coctailiconselected.png')}
                                           isSelected={this.state.isCocktails} size={50}
                                           selectedIcon={() => this.setState({isCocktails: true})}/>
                                ...
                                <View>
                                    <ZIcon photoUrlSelected={require('../Assets/drinkicon.png')}
                                           ...
                                           isSelected={this.state.isLunch} size={50}
                                           selectedIcon={() => this.setState({isLunch: true})}/>
                            ...
                            <View style={{
                                ...
                                <View style={{flexDirection: 'column'}}>
                                    <ZIcon photoUrlSelected={require('../Assets/foodsicon.png')}
                                           photoUrlUnSelected={require('../Assets/foodselectedicon.png')}
                                           isSelected={this.state.isFood} size={50}
                                           selectedIcon={() => this.setState({isFood: true})}/>
                                    <Text style={{paddingLeft: 7, color: '#5E5CBD', fontWeight: '500'}}>Food</Text>
                                </View>
                                <View style={{flexDirection: 'column'}}>
                                    <ZIcon photoUrlSelected={require('../Assets/foodicon.png')}
                                           photoUrlUnSelected={require('../Assets/foodiconselected.png')}
                                           isSelected={this.state.isBreakfast} size={50}
                                           selectedIcon={() => this.setState({isBreakfast: true})}/>
                        ...
                        <View style={{flex: 1, alignItems: 'flex-end'}}>
                            <TouchableOpacity onPress={() => this.setState({modalVisible: false})}
                                              style={{position: 'absolute', bottom: 195, left: 125}}>
        ...
        return (
            <ScrollView style={styles.container}
                ...
                <ZFullHeader
                    ...
                    rightText="SKIP" onPress={() => navigate('Dashboard', {name: 'dashboard'})}
                    rightTextPress={() => this.props.navigation.dispatch({
                ...
                <View style={styles.body}>
                    ...
                    <ZSliderCard>
                        <ZRoundedButton name="Type of Venue" isSelected={this.state.selected} selectedColor="#5F5FBA"
                                        selectedButton={(value) => this.getFilterByVenue('Type of Venue', 0, value)}/>
                        <ZRoundedButton name="Type of Service" isSelected={this.state.selected} selectedColor="#5F5FBA"
                                        selectedButton={(value) => this.getFilterByService('Type of Service', 0, value)}/>
                    </ZSliderCard>
