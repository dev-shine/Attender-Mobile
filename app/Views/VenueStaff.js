...
export default class VenueStaff extends Component {
  ...
  renderDeleteMonSched1 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showMonSched1: false, monstartTime1: '', monendTime1: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
  ...
  renderDeleteMonSched2 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showMonSched2: false, monstartTime2: '', monendTime2: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderDeleteTueSched1 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showTueSched1: false, tuestartTime1: '', tueendTime1: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderDeleteTueSched2 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showTueSched2: false, tuestartTime2: '', tuestartTime2: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderDeleteWedSched1 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showWedSched1: false, wedstartTime1: '', wedendTime1: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderDeleteWedSched2 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showWedSched2: false, wedstartTime2: '', wedstartTime2: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderDeleteThuSched1 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showThuSched1: false, thustartTime1: '', thuendTime1: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderDeleteThuSched2 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showThuSched2: false, thustartTime2: '', thuendTime2: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderDeleteFriSched1 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showFriSched1: false, fristartTime1: '', friendTime1: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderDeleteFriSched2 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showFriSched2: false, fristartTime2: '', friendTime2: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderDeleteSatSched1 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showSatSched1: false, satstartTime1: '', satendTime1: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderDeleteSatSched2 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showSatSched2: false, satstartTime2: '', satendTime2: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderDeleteSunSched1 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showSunSched1: false, sunstartTime1: '', sunendTime1: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderDeleteSunSched2 = () => {
    if (!this.state.isShowEditButton) {
      return(
        <TouchableOpacity onPress={() => this.setState({showSunSched2: false, sunstartTime2: '', sunendTime2: ''})} style={{position: 'absolute'}}>
          <View style={{borderRadius: 7, width: 14, height: 14, backgroundColor: '#5453B5', alignItems: 'center', left: 97, top: -22}}>
            <Icon name='md-close' size={14} color='white' style={{backgroundColor: 'transparent'}}/>
          </View>
        </TouchableOpacity>
  ...
  renderMondaySched1 = () => {
    if (this.state.isShowEditButton) {
      if (this.state.monstartTime1 == '' || this.state.monendTime1 == '') {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 8, paddingVertical: 5, alignItems: 'center', backgroundColor: '#FFFFFF'}}>
            <View>
        ...
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 8, paddingVertical: 5, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
      ...
      if (this.state.showMonSched1) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 5, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Monday1', 'start', this.state.monstartTime1)}>
                <ZMuteText text={this.state.monstartTime1 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Monday1', 'end', this.state.monendTime1)}>
                <ZMuteText text={this.state.monendTime1} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showMonSched1: true, monstartTime1: moment().format('hh A'), monendTime1: moment().format('hh A')})}>
    ...
    if (this.state.isShowEditButton) {
      ...
      if (this.state.showMonSched2) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 5, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Monday2', 'start', this.state.monstartTime2)}>
                <ZMuteText text={this.state.monstartTime2 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Monday2', 'end', this.state.monendTime2)}>
                <ZMuteText text={this.state.monendTime2} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showMonSched2: true, monstartTime2: moment().format('hh A'), monendTime2: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
    ...
    if (this.state.isShowEditButton) {
      ...
      if (this.state.showTueSched1) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 5, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Tuesday1', 'start', this.state.tuestartTime1)}>
                <ZMuteText text={this.state.tuestartTime1 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Tuesday1', 'end', this.state.tueendTime1)}>
                <ZMuteText text={this.state.tueendTime1} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showTueSched1: true, tuestartTime1: moment().format('hh A'), tueendTime1: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
    ...
    if (this.state.isShowEditButton) {
      ...
      if (this.state.showTueSched2) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 5, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Tuesday2', 'start', this.state.tuestartTime2)}>
                <ZMuteText text={this.state.tuestartTime2 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Tuesday2', 'end', this.state.tueendTime2)}>
                <ZMuteText text={this.state.tueendTime2} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showTueSched2: true, tuestartTime2: moment().format('hh A'), tueendTime2: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
    ...
    if (this.state.isShowEditButton) {
      ...
      if (this.state.showWedSched1) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 5, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Wednesday1', 'start', this.state.wedstartTime1)}>
                <ZMuteText text={this.state.wedstartTime1 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Wednesday1', 'end', this.state.wedendTime1)}>
                <ZMuteText text={this.state.wedendTime1} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showWedSched1: true, wedstartTime1: moment().format('hh A'), wedendTime1: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
    ...
    if (this.state.isShowEditButton) {
      ...
      if (this.state.showWedSched2) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 5, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Wednesday2', 'start', this.state.wedstartTime2)}>
                <ZMuteText text={this.state.wedstartTime2 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Wednesday2', 'end', this.state.wedendTime2)}>
                <ZMuteText text={this.state.wedendTime2} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showWedSched2: true, wedstartTime2: moment().format('hh A'), wedendTime2: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
    ...
    if (this.state.isShowEditButton) {
      ...
      if (this.state.showThuSched1) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 5, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Thursday1', 'start', this.state.thustartTime1)}>
                <ZMuteText text={this.state.thustartTime1 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Thursday1', 'end', this.state.thuendTime1)}>
                <ZMuteText text={this.state.thuendTime1} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showThuSched1: true, thustartTime1: moment().format('hh A'), thuendTime1: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
    ...
    if (this.state.isShowEditButton) {
      ...
      if (this.state.showThuSched2) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 5, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Thursday2', 'start', this.state.thustartTime2)}>
                <ZMuteText text={this.state.thustartTime2 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Thursday2', 'end', this.state.thuendTime2)}>
                <ZMuteText text={this.state.thuendTime2} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showThuSched2: true, thustartTime2: moment().format('hh A'), thuendTime2: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
    ...
    if (this.state.isShowEditButton) {
      ...
      if (this.state.showFriSched1) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 5, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Friday1', 'start', this.state.fristartTime1)}>
                <ZMuteText text={this.state.fristartTime1 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Friday1', 'end', this.state.friendTime1)}>
                <ZMuteText text={this.state.friendTime1} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showFriSched1: true, fristartTime1: moment().format('hh A'), friendTime1: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
    ...
    if (this.state.isShowEditButton) {
      ...
      if (this.state.showFriSched2) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 5, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Friday2', 'start', this.state.fristartTime2)}>
                <ZMuteText text={this.state.fristartTime2 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Friday2', 'end', this.state.friendTime2)}>
                <ZMuteText text={this.state.friendTime2} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showFriSched2: true, fristartTime2: moment().format('hh A'), friendTime2: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
    ...
    if (this.state.isShowEditButton) {
      ...
      if (this.state.showSatSched1) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 5, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Saturday1', 'start', this.state.satstartTime1)}>
                <ZMuteText text={this.state.satstartTime1 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Saturday1', 'end', this.state.satendTime1)}>
                <ZMuteText text={this.state.satendTime1} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showSatSched1: true, satstartTime1: moment().format('hh A'), satendTime1: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
  ...
  renderSaturdaySched2 = () => {
    if (this.state.isShowEditButton) {
      ...
      if (this.state.showSatSched2) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 10, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Saturday2', 'start', this.state.satstartTime2)}>
                <ZMuteText text={this.state.satstartTime2 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Saturday2', 'end', this.state.satendTime2)}>
                <ZMuteText text={this.state.satendTime2} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showSatSched2: true, satstartTime2: moment().format('hh A'), satendTime2: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
  ...
  renderSundaySched1 = () => {
    if (this.state.isShowEditButton) {
      if (this.state.sunstartTime1 == '' || this.state.sunendTime1 == '') {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 8, paddingVertical: 10, alignItems: 'center', backgroundColor: '#FFFFFF'}}>
            <View>
              <ZMuteText text={this.state.nullz} />
            </View>
            <View>
        ...
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 8, paddingVertical: 10, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
      ...
      if (this.state.showSunSched1) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 10, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Sunday1', 'start', this.state.sunstartTime1)}>
                <ZMuteText text={this.state.sunstartTime1 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Sunday1', 'end', this.state.sunendTime1)}>
                <ZMuteText text={this.state.sunendTime1} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showSunSched1: true, sunstartTime1: moment().format('hh A'), sunendTime1: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
    ...
    if (this.state.isShowEditButton) {
      ...
      if (this.state.showSunSched2) {
        return(
          <View style={{flex: 1, flexDirection: 'row', marginLeft: 10, paddingVertical: 10, alignItems: 'center', backgroundColor: '#F5F5F5'}}>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Sunday2', 'start', this.state.sunstartTime2)}>
                <ZMuteText text={this.state.sunstartTime2 + ' - '} />
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity onPress={()=>this.onShowTimePicker('Sunday2', 'end', this.state.sunendTime2)}>
                <ZMuteText text={this.state.sunendTime2} />
              </TouchableOpacity>
            </View>
        ...
        return(
          <View style={{flex: 1, margin: 2, paddingVertical: 5, alignItems: 'flex-start'}}>
            <TouchableOpacity onPress={()=> this.setState({showSunSched2: true, sunstartTime2: moment().format('hh A'), sunendTime2: moment().format('hh A')})}>
              <Image source={require('../Assets/plusiconcalendar.png')} style={{width: 20, height: 20, resizeMode: 'stretch', marginLeft: 6}}/>
            </TouchableOpacity>
          </View>
        )
  ...
  renderSaveButtton = (id) => {
    if (!this.state.isShowEditButton) {
      return(
        <ZRoundedButton name="Save" styles={{marginRight: 20}} normalButtonStyle={{backgroundColor: '#64DAE7', width: 140, alignSelf: 'center'}} normal={true} isSelected={this.state.selected} selectedColor="#5F5FBA" onPress={() => this.onSaveStaffSchedule(id)} />
      )
    }
  }
    ...
    if(this.state.isEditButton){
      ...
      return(
        <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginRight: 10}}>
          <View style={{flex: 1, justifyContent: 'flex-end', alignItems: 'flex-end', marginTop: 5}}>
            <TouchableOpacity onPress={() => this.onButtonPress()}>
              <Image source={require('../Assets/Save.png')} style={{margin: 4, height: 17, width: 17, resizeMode: 'stretch'}}/>
            </TouchableOpacity>
          </View>
      ...
      <View style={{flex: 1}}>
        {
          tasks.map((res, id) => {
            return(
              <View key={id} style={{width: '100%', marginHorizontal: 10, padding: 10, backgroundColor: 'white', borderRadius: 5, alignItems: 'flex-start', justifyContent: 'flex-start'}}>
                <View style={{width: '95%', flexDirection: 'row', borderWidth: (this.state.buttonStateTaskSuggest ? 0 : 0.5)}}>
                  ...
                  <View style={{justifyContent: 'center', alignItems: 'center'}}>
                    <TextInput placeholder='type task here..' editable={this.state.editableState} multiline={true} onChangeText={(value) => this.onChangeTaskText(value, id)} value={res.description} style={{width: 260, height: 40, fontSize: 15, color: '#393650', padding: 10}}/>
                  </View>
                  {
                    this.state.editableState ?
                    <View style={{ alignItems: 'flex-end'}}>
                      <TouchableOpacity onPress={()=>this.onRemoveTaskPress(res._id)} style={{position: 'absolute', top: -9, left: -6}}>
                ...
                <View key={id} style={{width: '100%', marginHorizontal: 10, padding: 10, backgroundColor: 'white', borderRadius: 5, alignItems: 'flex-start', justifyContent: 'flex-start'}}>
                  <View style={{width: '95%', flexDirection: 'row', borderWidth: (this.state.buttonStateTaskSuggest ? 0 : 0.5)}}>
                    ...
                    <View style={{justifyContent: 'center'}}>
                      <TextInput placeholder='type task here..' editable={this.state.editableState} multiline={true} onChangeText={(value) => this.onChangeSuggestionText(value, id)} value={res.description} style={{width: 260, height: 40, fontSize: 15, color: '#393650', padding: 10}}/>
                    </View>
                    {
                      this.state.editableState ?
                      <View style={{ alignItems: 'flex-end'}}>
                        <TouchableOpacity onPress={()=>this.onRemoveSuggestPress(res._id)} style={{position: 'absolute', top: -9, left: -6}}>
                          <View style={{backgroundColor:'#5D5CAA', width: 16, height: 16, borderRadius: 8, justifyContent: 'center', alignItems: 'center'}}>
                            <Icon name="ios-remove" size={45} color="white" style={{backgroundColor: 'transparent', width: 10, paddingTop: 5}} />
                          </View>
                        </TouchableOpacity>
          ...
          <View style={{flex: 1}}>
            ...
            <View style={{flex: 1}}>
              <View style={{alignItems: 'center', justifyContent: 'center', marginTop: 50}}>
                <Image style={{width: 60, height: 60, borderRadius: 30}} source={{uri: res.staff.avatar}}/>

                <View style={{justifyContent: 'center', alignItems: 'center', margin: 10}}>
                  <ZText text={res.staff.fullname} styles={{marginTop: 1, fontSize: 18, fontWeight: 'bold'}}/>
                </View>
                ...
                <View style={{backgroundColor: 'white', marginBottom: 10, marginTop: 0, borderRadius: 5}}>
                  <View style={{marginVertical: 20, padding: 15}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                      <View style={{flex: 1}}>
                        {
                          this.state.isShowEditButton ?
                            <TouchableOpacity style={{position: 'absolute', top: -55, left: -15}} onPress={() => this.setState({isShowEditButton: false})}>
                              <View style={{alignItems: 'center', justifyContent: 'center', backgroundColor: 'transparent', width: 50, height: 50}}>
                      ...
                      <View style={{flex: 1}}>
                        <TouchableOpacity style={{position: 'absolute', top: -58, left: 138}} onPress={() => this.setState({isShowStaffSchedule: false})}>
                          <View style={{alignItems: 'center', justifyContent: 'center', backgroundColor: '#F5F5F5', margin: 10, width: 30, height: 30, borderRadius: 15}}>
          ...
          this.state.bartenders.map((res, index)=>{
            return (
              <ZCard key={index} styles={{borderWidth: 0, backgroundColor: 'white', margin: 5}}>
                <TouchableOpacity onPress={() => this.setState({isTrialShow: false, isActiveContent: true, selectedStaff: res})}>
                ...
                <View style={{marginVertical: 10}}>
                  <ZRoundedButton name="Send Message" styles={{marginRight: 0}} normal={true} isSelected={this.state.selected} selectedColor="#5F5FBA" onPress={() => this.getConversationId(userProfile, myProfile)} />
                </View>
                ...
                <TouchableOpacity onPress={() => this.onSelectStaffSchedule(res)} style={{position: 'absolute', top: 20, right: 10}}>
                  <View>
                    <Icon name="md-calendar" size={30} color="#716D7B"  />
                  </View>
                </TouchableOpacity>

                <TouchableOpacity onPress={() => this.onPayStaff(res)} style={{position: 'absolute', top: 20, left: 10}}>
                  <View>
  ...
  renderActiveStaff = () => {
    const { navigate } = this.props.navigation;
    return (
      <ScrollView style={styles.container} contentContainerStyle={{top: 0, paddingBottom: 50, justifyContent: 'center', bottom: 50}}>
        {/**<ZHeaderTab
        ...
        <View style={styles.plainBody}>
          ...
          <ZSliderCard>
            ...
            <ZIcon photoUrlSelected={require('../Assets/managericonselected.png')} photoUrlUnSelected={require('../Assets/managericon.png')} iconText="Bartenders" isSelected={this.state.isBartender} selectedIcon={(value)=>this.getSelectedType('bartender', 0, value)} />
            <ZIcon photoUrlSelected={require('../Assets/managericonselected.png')} photoUrlUnSelected={require('../Assets/managericon.png')} iconText="Manager" isSelected={this.state.isManager} selectedIcon={(value)=>this.getSelectedType('manager', 1, value)} />
            <ZIcon photoUrlSelected={require('../Assets/waitericonselected.png')} photoUrlUnSelected={require('../Assets/waitericon.png')} iconText="Waiter" isSelected={this.state.isWaiter} selectedIcon={(value)=>this.getSelectedType('waiter', 2, value)} />

            <ZIcon photoUrlSelected={require('../Assets/cookiconselected.png')} photoUrlUnSelected={require('../Assets/cookicon.png')} iconText="Kitchen" isSelected={this.state.isKitchen} selectedIcon={(value)=>this.getSelectedType('kitchen', 4, value)} />
            <ZIcon photoUrlSelected={require('../Assets/barbackiconselected.png')} photoUrlUnSelected={require('../Assets/barbackicon.png')} iconText="Barbacks" isSelected={this.state.isBarbacks} selectedIcon={(value)=>this.getSelectedType('barback', 5, value)} />
            <ZIcon photoUrlSelected={require('../Assets/hosticonselected.png')} photoUrlUnSelected={require('../Assets/hosticon.png')} iconText="Host" isSelected={this.state.isHost} selectedIcon={(value)=>this.getSelectedType('host', 6, value)} />
        ...
        <ScrollView style={styles.container} contentContainerStyle={[styles.scrollContent, {top: 0, paddingBottom: 50}]}>
          ...
          <View style={styles.body}>
            ...
            <View style={{flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', paddingVertical: 15}}>
              ...
              <View style={{flex: 1}}>
                <ZAvatar source={this.props.navigation.state.params ? this.props.navigation.state.params.userData.employer.image : 'https://www.nztcc.org/themes/kos/images/avatar.png'} hideIndicator={true} />
                <ZText text={this.props.navigation.state.params ? this.props.navigation.state.params.userData.employer.name : ''} styles={{fontSize: 14}}/>
              </View>

              <View style={{flex: 1}}>
                <ZAvatar source={this.state.selectedStaff.staff.avatar || 'https://www.nztcc.org/themes/kos/images/avatar.png'} hideIndicator={true} />
        ...
        <View style={{position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'white'}}>
          <ScrollView style={styles.container} contentContainerStyle={[styles.scrollContent, {top: 0, paddingBottom: 50}]}>
            ...
            <View style={{marginVertical: 10, flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
              <ZRoundedButton name="Hire Now" styles={{marginRight: 20}} normalButtonStyle={{backgroundColor: '#64DAE7', width: 140, alignSelf: 'center'}} normal={true} isSelected={this.state.selected} selectedColor="#5F5FBA" onPress={()=>this.onDirectHire()}/>
            </View>
          </ScrollView>
        </View>
      )
