...
//for gender
        ...
        var certificateData = []
        res.licenses.map((item) => {
            if (item.length>0) {
                certificateData.push({label: item, value: item})
            }
        })
        res.certificates.map((item) => {
            if (item.length>0) {
                certificateData.push({label: item, value: item})
            }
        })
        this.setState({
            ...
            certificateDataLabel: res.licenses.concat(res.certificates),
            ...
            if (res.status) {
                if (this.props.navigation.state.params.editMode) {
                    this.props.navigation.dispatch({
                        ...
                        index: 0,
                        actions: [{type: 'Navigate', routeName: 'Home', params: {avatar: this.state.photo}}]
                    })
                } else {
                    navigate('VenueSearch', {
            ...
            <Validate isValidated={this.state.FIELDS.describe} margin={false}>
                <TouchableOpacity onPress={() => this.onShowSelectionPicker('qualities')}>
                    <View style={{
                        ...
                        <TextInput underlineColorAndroid="transparent" ref={'descText'} editable={false}
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity onPress={() => this.onRemoveItem(id)}>
                            <View style={{
                                ...
                                <Icon name="ios-remove" size={15} color="white"
                    ...
                    <View>
                        ...
                        <View style={{
                            ...
                            <Text style={{
                                ...
                                marginRight: 8,
                                flex: 1
                            }}>{moment(this.state.selectedBirthday).format('DD / MMMM / YYYY')}</Text>
                            <View>
                                <View style={{flex: 1, flexDirection: 'column'}}>
                                    <TouchableOpacity onPress={() => this.onNextDate()}>
                                        <View style={{flex: 1}}>
                                            <Icon name="ios-arrow-up" size={15}
                                                  style={{backgroundColor: 'transparent'}}/>
                                        </View>
                                    </TouchableOpacity>
                                    <TouchableOpacity onPress={() => this.onPrevDate()}>
                                        <View style={{flex: 1}}>
                                            <Icon name="ios-arrow-down" size={15}
                                                  style={{backgroundColor: 'transparent'}}/>
                                        </View>
                                    </TouchableOpacity>
                                </View>
                ...
                return (
                    <TouchableOpacity style={{flex: 1}} onPress={() => this.onSelectGender('male')}>
                        <View style={{
                            ...
                            <Icon name={icon} size={15} color="#7B7A81"
                                  style={{backgroundColor: 'transparent', marginRight: 8}}/>
            ...
            return (
                <View style={{flexDirection: 'row'}}>
                    ...
                    <View style={{backgroundColor: '#FAFAFA', justifyContent: 'center', alignItems: 'center'}}>
                        <TextInput placeholder="Type other gender" underlineColorAndroid="transparent"
                                   autoCorrect={false} spellCheck={false}
                                   style={{textAlign: 'center', height: 40, width: 160, color: '#7B7A81', fontSize: 14}}
                                   onChangeText={(otherGender) => this.setState({otherGender})}/>
                    </View>
                </View>
            )
        } else {
    ...
    renderLanguage = () => {
        return (
            <Validate isValidated={this.state.FIELDS.language} margin={false}>
                <Text style={{fontSize: 12, fontWeight: 'bold', color: '#A8A5AE', marginBottom: 3}}>Spoken
                    Languages</Text>
                <TouchableOpacity onPress={() => this.onShowSelectionPicker('languages')}>
                    <View style={{
                        ...
                        <TextInput underlineColorAndroid="transparent" ref={'language'} editable={false}
                                   placeholder="Select Language" style={{width: '100%', height: 40, fontSize: 14}}
                                   onChangeText={(languageValue) => this.setState({languageValue})}/>
                        <View style={{
                            backgroundColor: '#5D5CAA',
                            width: 20,
                            height: 20,
                ...
                <View key={id} style={{marginBottom: 5}}>
                    <View style={{
                        ...
                        <View style={{flexDirection: 'row', flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                            <Image source={flags[index]}
                                   style={{width: 30, height: 20, resizeMode: 'stretch', marginRight: 10}}/>
                            <Text
                                style={{fontSize: 16, fontWeight: 'bold', color: '#45434F', flex: 1}}>{res.value}</Text>
                        </View>
    ...
    renderCustomMarker = () => {
        return (<Image source={require('../Assets/Sliding-button.png')} style={{height: 16, width: 12}}
                       resizeMode='contain'/>)
    }
    ...
    renderCertificate = () => {
        return (
            <Validate isValidated={this.state.FIELDS.certificate} margin={false}>
                <Text style={{fontSize: 12, fontWeight: 'bold', color: '#A8A5AE', marginBottom: 3}}>Licenses and
                    Certifications</Text>
                <TouchableOpacity onPress={() => this.onShowSelectionPicker('certificates')}>
                    <View style={{
                        ...
                        <TextInput underlineColorAndroid="transparent" ref={'certificate'} editable={false}
                                   placeholder="Select" style={{flex: 1, height: 40, fontSize: 14}}
                ...
                <View style={{flexDirection: 'row'}}>
                    <TouchableOpacity onPress={() => this.onShowSelectionPicker('workEligibility')}>
                        <View style={{
                            ...
                            <Text style={{fontSize: 14, fontWeight: '500', color: '#BABABA', flex: 1}}>Work
                                Eligibility</Text>
                            <View style={{
                                backgroundColor: '#5D5CAA',
                                width: 20,
    ...
    onSelectMutiple = () => {
        if (this.state.selectionType == 'workType') {
            ...
            console.log("onSelectMutiple", data)
                    ...
                    <Modal transparent={true} visible={this.state.onShowMultiSelection}>
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <SelectMultiple items={workType} selectedItems={this.state.workTypeData}
                                ...
                                <View style={{
                                    ...
                                    <ZRoundedButton name="Select" styles={{marginRight: 10}} normalButtonStyle={{
                                        backgroundColor: '#64DAE7',
                                        alignSelf: 'center',
                                        width: 150
                                    }} normal={true} isSelected={this.state.selected} selectedColor="#5F5FBA"
                                                    onPress={() => this.onSelectMutiple()}/>
                                    <ZRoundedButton name="Cancel" styles={{marginRight: 0}} normalButtonStyle={{
                                        backgroundColor: '#64DAE7',
                                        alignSelf: 'center',
                                        width: 150
                                    }} normal={true} isSelected={this.state.selected} selectedColor="#5F5FBA"
                                                    onPress={() => this.onCancelSelectionsChange()}/>
                                </View>
                            </View>
                        </View>
                    </Modal>
                    ...
                    <Modal transparent={true} visible={this.state.onShowMultiSelection}>
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <SelectMultiple items={workEligibility} selectedItems={this.state.workEligibilityData}
                                                onSelectionsChange={this.onSelectionsChange}/>
                                <View style={{
                                    flexDirection: 'row',
                                    justifyContent: 'center',
                    ...
                    <Modal transparent={true} visible={this.state.onShowMultiSelection}>
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <SelectMultiple items={qualities} selectedItems={this.state.describeData}
                                                onSelectionsChange={this.onSelectionsChange}/>
                                <View style={{
                                    flexDirection: 'row',
                                    justifyContent: 'center',
                    ...
                    <Modal transparent={true} visible={this.state.onShowMultiSelection}>
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <SelectMultiple items={languages} selectedItems={this.state.language}
                                                onSelectionsChange={this.onSelectionsChange}/>
                                <View style={{
                                    flexDirection: 'row',
                                    justifyContent: 'center',
                    ...
                    <Modal transparent={true} visible={this.state.onShowMultiSelection}>
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <SelectMultiple items={certificates} selectedItems={this.state.certificateData}
                                                onSelectionsChange={this.onSelectionsChange}/>
                                <View style={{
                                    flexDirection: 'row',
                                    justifyContent: 'center',
    ...
    renderHeader = () => {
        if (!this.props.isSettings) {
            return (
                <ZFullHeader headerTitle="Profile Set up" subTitle="We need just a few details to get you started"
        ...
        return (
            <View key={key}>
                <View style={{marginVertical: 5, flexDirection: 'row'}}>
                    <ZTextInput placeholder="Company" radius={false}
                                onChangeText={(text) => this.setState({companyValue: text})} value={val.companyValue}
                                styles={{flex: 1, marginRight: 5}}/>
                    <ZTextInput placeholder="Position" radius={false}
                                onChangeText={(text) => this.setState({positionValue: text})} value={val.positionValue}
                                styles={{flex: 1}}/>
                </View>

                <View style={{marginVertical: 5, flexDirection: 'row', alignItems: 'flex-end'}}>
                    <ZTextInput name="location" placeholder="Location" radius={false}
                                onChangeText={(text) => this.setState({locationValue: text})} value={val.locationValue}
                                styles={{flex: 1, marginRight: 5}}/>

                    <TouchableOpacity style={{flex: 1, marginTop: (Platform.OS === 'ios' ? 0 : 11)}}
                                      onPress={() => this.setState({isDurationPicker: true})}>
                        <View style={{marginRight: 5}}>
                            ...
                            <View
                                style={{backgroundColor: '#F5F5F5', padding: 5, paddingVertical: 15, paddingLeft: 10}}>
                                <Text style={{
                                    color: '#33314B',
                                    fontSize: 16
                                }}>{moment(val.startDuration).format('MMM YYYY')}</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity style={{flex: 1, marginTop: (Platform.OS === 'ios' ? 0 : 11)}}
                        ...
                        <View>
                            <Text
                                style={{fontSize: 12, fontWeight: 'bold', color: '#A8A5AE', marginBottom: 3}}>To</Text>
                            <View
                                style={{backgroundColor: '#F5F5F5', padding: 5, paddingVertical: 15, paddingLeft: 10}}>
                                <Text style={{
                                    color: '#33314B',
                                    fontSize: 16
                                }}>{moment(val.endDuration).format('MMM YYYY')}</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
                ...
                <View style={{marginVertical: 5}}>
                    <ZTextInput placeholder="Additonal Information" multiline={true} maxLength={200} radius={false}
                                onChangeText={(text) => this.setState({additionalValue: text})}
                                value={val.additionalValue} styles={{flex: 1}}/>
                    <Text style={{
                        fontSize: 12,
                        fontWeight: '500',
                        color: '#D4D4D4',
                        textAlign: 'right'
                    }}>{val.additionalValue ? val.additionalValue.length : 0}/200</Text>
                </View>
            </View>
        )
    }
    ...
    render() {
        ...
        return (
            <View style={{flex: 1}}>
                <ScrollView
                    style={[styles.container, {backgroundColor: (!this.props.isSettings ? '#F5F5F5' : 'white')}]}
                    ...
                    <View style={styles.body}>
                        ...
                        <Form ref="form">
                            <Validate isValidated={this.state.FIELDS.fullname}>
                                <ZTextInput type="TextInput" name="fullname" placeholder="Full name"
                                            defaultValue={this.props.navigation.state.params ? this.props.navigation.state.params.fullname : ''}
                                            value={this.state.fullname} returnKeyType="next" radius={false}
                                            onChangeText={(value) => this.onValidateFields('fullname', value)}/>
                            </Validate>
                            <Validate isValidated={this.state.FIELDS.bio}>
                                <ZTextInput type="TextInput" name="bio" placeholder="Bio" value={this.state.bio}
                                            multiline={true} maxLength={200} returnKeyType="next" radius={false}
                                            onChangeText={(text) => {
                                                this.onChangeText(text);
                                                this.onValidateFields('bio', text)
                                            }}/>
                                                <Text style={{
                                                    fontSize: 12,
                                                    fontWeight: '500',
                                                    color: '#D4D4D4',
                                                    textAlign: 'right'
                                                }}>{this.state.FIELDS.bio ? this.state.FIELDS.bio.length : 0}/200</Text>
                                                </Validate>
                                                </Form>
                                            ...
                                            {this.renderSelectedLanguage()}
                                                ...
                                                <ZHero text="Position" styles={{
                                                    color: '#33314B',
                                                    fontSize: 16,
                                                    marginBottom: 5
                                                }}/>
                                                <ZHero text="Tap on the position(s) that you are interested in"
                                                styles={{color: '#33314B', fontWeight: '300', fontSize: 12}}/>
                                                </View>
                                                <Validate isValidated={this.state.FIELDS.position}>
                                                <View style={{flexDirection: 'row'}}>
                                                <ZSliderCard>
                                                <ZIcon photoUrlSelected={require('../Assets/managericonselected.png')}
                                                photoUrlUnSelected={require('../Assets/managericon.png')}
                                                iconText="Bartender" isSelected={this.state.isBartender}
                                                selectedIcon={(value) => this.onSelectJobType('bartender', 0, value)}/>
                                                <ZIcon photoUrlSelected={require('../Assets/managericonselected.png')}
                                                photoUrlUnSelected={require('../Assets/managericon.png')} iconText="Manager"
                                                isSelected={this.state.isManager}
                                                selectedIcon={(value) => this.onSelectJobType('manager', 1, value)}/>
                                                <ZIcon photoUrlSelected={require('../Assets/waitericonselected.png')}
                                                photoUrlUnSelected={require('../Assets/waitericon.png')}
                                                iconText="Waiter/Waitress" isSelected={this.state.isWaiter}
                                                selectedIcon={(value) => this.onSelectJobType('waiter', 2, value)}/>
                                                ...
                                                selectedIcon={(value) => this.onSelectJobType('chef', 3, value)}/>
                                                <ZIcon photoUrlSelected={require('../Assets/cookiconselected.png')}
                                                photoUrlUnSelected={require('../Assets/cookicon.png')}
                                                iconText="Kitchen Hand" isSelected={this.state.isKitchen}
                                                selectedIcon={(value) => this.onSelectJobType('kitchen', 4, value)}/>
                                                ...
                                                selectedIcon={(value) => this.onSelectJobType('barback', 5, value)}/>
                                                ...
                                                <ZMuteText text="Hourly Rate" styles={{
                                                    color: '#D0D0D0',
                                                    textAlign: 'left',
                                                    marginRight: 20,
                                                    fontWeight: '500'
                                                }}/>
                                                <ZMuteText text={`$${this.state.rate1}/hr`}
                                                styles={{color: '#5E5DBB', textAlign: 'left', fontWeight: '500'}}/>
                                                <ZMuteText text=" - " styles={{color: '#5E5DBB', fontWeight: '500'}}/>
                                                <ZMuteText text={`$${this.state.rate2}/hr`}
                                                styles={{color: '#5E5DBB', textAlign: 'left', fontWeight: '500'}}/>
                                                </View>
                                                </Validate>
                                                </View>
                                                <ZMuteText text="$150/h" styles={{
                                                    color: '#D0D0D0',
                                                    textAlign: 'right',
                                                    marginBottom: 10,
                                                    fontWeight: '500'
                                            ...
                                            {this.renderWorkEligibility()}
                                                ...
                                                <TextInput ref={() => this.location} value={this.state.location}
                                                ...
                                                <ZMuteText text="Distance" styles={{
                                                    color: '#D0D0D0',
                                                    textAlign: 'left',
                                                    marginRight: 20,
                                                    fontWeight: '500'
                                                }}/>
                                                <ZMuteText text={this.state.distance}
                                                styles={{color: '#5E5DBB', textAlign: 'left', fontWeight: '500'}}/>
                                                </View>
                                                </Validate>
                                                <MultiSlider
                                                ...
                                                <ZHero text="Availability (Optional)"
                                                styles={{color: '#AFAFAF', fontWeight: '500', fontSize: 14, textAlign: 'left'}}/>
                                                <ZHero text="Tap on the box to fill your available schedule"
                                                styles={{
                                                    color: '#AFAFAF',
                                                    fontWeight: '400',
                                                    fontSize: 11,
                                                ...
                                                onPress={() => this.onSelectSchedule('Monday', 'Morning')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isMondayMorning ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isMondayMorning ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isMondayMorning ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Monday', 'Afternoon')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isMondayAfternoon ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isMondayAfternoon ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isMondayAfternoon ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Monday', 'Evening')}>
                                                <View style={{
                                                justifyContent: 'center',
                                                alignItems: 'center',
                                                padding: 10,
                                                paddingVertical: 15,
                                                backgroundColor: (this.state.isMondayEvening ? '#5FDAE9' : 'white'),
                                                borderWidth: 0.5,
                                                borderColor: '#eee'
                                            }}>
                                                <View style={{
                                                backgroundColor: (this.state.isMondayEvening ? '#5FDAE9' : '#D9F9FA'),
                                                width: 20,
                                                height: 20,
                                                borderRadius: 10,
                                                justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isMondayEvening ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                ...
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Tuesday', 'Morning')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isTuesdayMorning ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isTuesdayMorning ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isTuesdayMorning ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Tuesday', 'Afternoon')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isTuesdayAfternoon ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isTuesdayAfternoon ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isTuesdayAfternoon ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Tuesday', 'Evening')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isTuesdayEvening ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isTuesdayEvening ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isTuesdayEvening ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                ...
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Wednesday', 'Morning')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isWedMorning ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isWedMorning ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isWedMorning ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Wednesday', 'Afternoon')}>
                                                <View style={{
                                                justifyContent: 'center',
                                                alignItems: 'center',
                                                padding: 10,
                                                paddingVertical: 15,
                                                backgroundColor: (this.state.isWedAfternoon ? '#5FDAE9' : 'white'),
                                                borderWidth: 0.5,
                                                borderColor: '#eee'
                                            }}>
                                                <View style={{
                                                backgroundColor: (this.state.isWedAfternoon ? '#5FDAE9' : '#D9F9FA'),
                                                width: 20,
                                                height: 20,
                                                borderRadius: 10,
                                                justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isWedAfternoon ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Wednesday', 'Evening')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isWedEvening ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isWedEvening ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isWedEvening ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                ...
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Thursday', 'Morning')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isThursMorning ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isThursMorning ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isThursMorning ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Thursday', 'Afternoon')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isThursAfternoon ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isThursAfternoon ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isThursAfternoon ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Thursday', 'Evening')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isThursEvening ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isThursEvening ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isThursEvening ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                ...
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Friday', 'Morning')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isFridayMorning ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isFridayMorning ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isFridayMorning ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Friday', 'Afternoon')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isFridayAfternoon ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isFridayAfternoon ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isFridayAfternoon ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Friday', 'Evening')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isFridayEvening ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isFridayEvening ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isFridayEvening ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                            ...
                                            {this.renderDay('Saturday')}
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Saturday', 'Morning')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isSaturdayMorning ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isSaturdayMorning ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isSaturdayMorning ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Saturday', 'Afternoon')}>
                                                <View style={{
                                                justifyContent: 'center',
                                                alignItems: 'center',
                                                padding: 10,
                                                paddingVertical: 15,
                                                backgroundColor: (this.state.isSaturdayAfternoon ? '#5FDAE9' : 'white'),
                                                borderWidth: 0.5,
                                                borderColor: '#eee'
                                            }}>
                                                <View style={{
                                                backgroundColor: (this.state.isSaturdayAfternoon ? '#5FDAE9' : '#D9F9FA'),
                                                width: 20,
                                                height: 20,
                                                borderRadius: 10,
                                                justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isSaturdayAfternoon ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Saturday', 'Evening')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isSaturdayEvening ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isSaturdayEvening ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isSaturdayEvening ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                ...
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Sunday', 'Morning')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isSundayMorning ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isSundayMorning ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isSundayMorning ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Sunday', 'Afternoon')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isSundayAfternoon ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isSundayAfternoon ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isSundayAfternoon ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={{flex: 1}}
                                                onPress={() => this.onSelectSchedule('Sunday', 'Evening')}>
                                                <View style={{
                                                    justifyContent: 'center',
                                                    alignItems: 'center',
                                                    padding: 10,
                                                    paddingVertical: 15,
                                                    backgroundColor: (this.state.isSundayEvening ? '#5FDAE9' : 'white'),
                                                    borderWidth: 0.5,
                                                    borderColor: '#eee'
                                                }}>
                                                <View style={{
                                                    backgroundColor: (this.state.isSundayEvening ? '#5FDAE9' : '#D9F9FA'),
                                                    width: 20,
                                                    height: 20,
                                                    borderRadius: 10,
                                                    justifyContent: 'center',
                                                ...
                                                <Icon name="ios-add" size={15}
                                                color={this.state.isSundayEvening ? '#5FDAE9' : 'white'}
                                                style={{backgroundColor: 'transparent'}}/>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                ...
                                                <View style={{marginVertical: 5, flexDirection: 'row'}}>
                                                <ZTextInput type="TextInput" name="company" placeholder="Company" radius={false}
                                                onChangeText={(text) => this.setState({companyValue: text})}
                                                value={this.state.companyValue} styles={{flex: 1, marginRight: 5}}/>
                                                <ZTextInput type="TextInput" name="position" placeholder="Position" radius={false}
                                                onChangeText={(text) => this.setState({positionValue: text})}
                                                value={this.state.positionValue} styles={{flex: 1}}/>
                                                </View>

                                                <View style={{marginVertical: 5, flexDirection: 'row', alignItems: 'flex-end'}}>
                                                <ZTextInput type="TextInput" name="location" placeholder="Location" radius={false}
                                                onChangeText={(text) => this.setState({locationValue: text})}
                                                value={this.state.locationValue} styles={{flex: 1, marginRight: 5}}/>

                                                <TouchableOpacity style={{
                                                    flex: 1,
                                                    marginTop: (Platform.OS === 'ios' ? 0 : 11)
                                                }}
                                                onPress={() => this.onPressDuration('start')}>
                                                <View style={{marginRight: 5}}>
                                                <Text style={{
                                                    fontSize: 12,
                                                    fontWeight: 'bold',
                                                ...
                                                <Text style={{
                                                    color: '#33314B',
                                                    fontSize: 16
                                                }}>{moment(this.state.startDuration).format('MMM YYYY')}</Text>
                                                </View>
                                                </View>
                                                </TouchableOpacity>

                                                <TouchableOpacity style={{flex: 1, marginTop: (Platform.OS === 'ios' ? 0 : 11)}}
                                                onPress={() => this.onPressDuration('end')}>
                                                <View>
                                                <Text style={{
                                                fontSize: 12,
                                                fontWeight: 'bold',
                                                ...
                                                <Text style={{
                                                    color: '#33314B',
                                                    fontSize: 16
                                                }}>{moment(this.state.endDuration).format('MMM YYYY')}</Text>
                                                </View>
                                                </View>
                                                </TouchableOpacity>
                                                ...
                                                <View style={{marginVertical: 5}}>
                                                <ZTextInput type="TextInput" name="additionalInfo"
                                                placeholder="Additonal Information" multiline={true} maxLength={200}
                                                radius={false} value={this.state.additionalValue} styles={{flex: 1}}
                                                onChangeText={(text) => this.onChangeTextAdInfo(text)}/>
                                                <Text style={{
                                                    fontSize: 12,
                                                    fontWeight: '500',
                                                    color: '#D4D4D4',
                                                    textAlign: 'right'
                                                }}>{this.state.textLengthAdInfo}/200</Text>
                                                </View>
                                                </Form>
                                                </View>
                                                ...
                                                <ZRoundedButton name="Save" styles={{marginRight: 20}} normalButtonStyle={{
                                                    backgroundColor: '#64DAE7',
                                                    width: 140,
                                                    alignSelf: 'center'
                                                }} normal={true} isSelected={this.state.selected} selectedColor="#5F5FBA"
                                                onPress={() => this.onSaveProfile()}/>
                                                <ZRoundedButton name="Clear all" styles={{marginRight: 0}} normalButtonStyle={{
